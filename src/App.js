...
import './App.css';
import Rent from './Compnent/renj'
import Add from  './Compnent/Additem';
import {
...
function App() {
  ...
  const [cardSite, setcardSite] = useState(false);
    ...
    <div className="App">
      ...
      <Card>
        ...
        <CardBody>
          ...
          <Rent onClick={Carddetails}/>
          {/* <Button onClick={Carddetails}>Card Detailes</Button> */}
          <Add/>
       </>)
      }
      </>
